...
Model.prototype.refreshAttributes = function() {
  ...
  _.each(this.rawAttributes, function(definition, name) {
    ...
    if (definition.type instanceof DataTypes.BOOLEAN) {
      ...
      if (definition.type instanceof DataTypes.DATEONLY) {
        self._dateOnlyAttributes.push(name);
      }
  ...
  this._hasDateOnlyAttributes = !!this._dateOnlyAttributes.length;
  this._isDateOnlyAttribute = Utils._.memoize(function(key) {
    return self._dateOnlyAttributes.indexOf(key) !== -1;
  });
